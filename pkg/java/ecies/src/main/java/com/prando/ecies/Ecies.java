package com.prando.ecies;

import com.prando.ecies.common.AESGCMBlockCipher;
...
public class Ecies {
     ...
     */
    public static ECKeyPair generateEcKeyPair() throws InvalidAlgorithmParameterException, NoSuchAlgorithmException {
     ...
     */
    public static String encrypt(String publicKeyHex, String message) throws InvalidCipherTextException, InvalidAlgorithmParameterException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchProviderException {
     ...
     */
    public static String decrypt(String privateKeyHex, String ciphertext) throws InvalidCipherTextException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchProviderException {
     ...
     */
    public static byte[] encrypt(byte[] publicKeyBytes, byte[] message) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidCipherTextException, NoSuchPaddingException, NoSuchProviderException {
        ECNamedCurveParameterSpec ecSpec = ECNamedCurveTable.getParameterSpec(CURVE_NAME);
     ...
     */
    public static byte[] decrypt(byte[] privateKeyBytes, byte[] cipherBytes) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidCipherTextException, NoSuchPaddingException, NoSuchProviderException {
        ECNamedCurveParameterSpec ecSpec = ECNamedCurveTable.getParameterSpec(CURVE_NAME);
        KeyFactory keyFactory = getKeyFactory();
        org.bouncycastle.jce.spec.ECNamedCurveSpec curvedParams = new ECNamedCurveSpec(CURVE_NAME, ecSpec.getCurve(), ecSpec.getG(), ecSpec.getN());
